...
import numpy as np
# Outputs only recursive prediction 
class AmuletNet(nn.Module):
    def __init__(self, original_model):
        ...
        self.SMP_combine_0 = nn.Conv2d(in_channels = SMP_out_channel, out_channels = 1, kernel_size=1,stride=1)
        
        # Activation Function
        self.relu = nn.ReLU()
        
       # Final Saliency prediction
        self.salient_predict = nn.Conv2d(in_channels=integrated_res_channel, out_channels=1, kernel_size=1, stride=1)
