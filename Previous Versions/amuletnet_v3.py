...
import numpy as np
# Foreground excitation map and incorrect upsampling
class AmuletNet(nn.Module):
    def __init__(self, original_model):
        ...
        self.final_prediction =  nn.Conv2d(in_channels=SMP_out_channel, out_channels=1, kernel_size=1, stride=1)
    ...
    def forward(self, x):
        ...
        final_prediction = self.final_prediction(self.relu(SMP_out_0 + self.br(out_1)))
