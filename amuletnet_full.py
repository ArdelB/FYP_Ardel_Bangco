...
class AmuletNet(nn.Module):
    def __init__(self, original_model):
        ...
        self.prediction_0 =  nn.Conv2d(in_channels=SMP_out_channel, out_channels=SMP_out_channel, kernel_size=1, stride=1)
        self.prediction_1 =  nn.Conv2d(in_channels=SMP_out_channel, out_channels=SMP_out_channel, kernel_size=1, stride=1)
        self.prediction_2 =  nn.Conv2d(in_channels=SMP_out_channel, out_channels=SMP_out_channel, kernel_size=1, stride=1)
        self.prediction_3 =  nn.Conv2d(in_channels=SMP_out_channel, out_channels=SMP_out_channel, kernel_size=1, stride=1)
        self.prediction_4 =  nn.Conv2d(in_channels=SMP_out_channel, out_channels=SMP_out_channel, kernel_size=1, stride=1)
        
        # Final Saliency Prediction
        self.final_prediction = nn.Conv2d(in_channels=5*SMP_out_channel, out_channels=SMP_out_channel, kernel_size=1, stride=1)
